...
class InflationPredictor:
    ...
    def create_future_periods(self, df_pandas: pd.DataFrame, start_month: int = 4, end_month: int = 9) -> pd.DataFrame:
    ...
    def predict_iteratively(self, full_df: pd.DataFrame, start_month: int = 4, end_month: int = 9) -> List[Tuple[int, int, float]]:
